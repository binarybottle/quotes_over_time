...
// overwritten if $stdout==1
       ...
       $topic_num          = 53;            // Grab this numbered topic from database

       $grab_stories       = 0;             // Grab stories from database
       ...
       $stop_time          = '1111111111'; //'1157760000';  // Show data UNTIL this epoch time
   ...
   $show_all = 0; // Show quotes from entire history
   if ($show_all==1) { 
